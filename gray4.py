...
while output.IsStreaming():
 ...
 #   imgInput = jetson.utils.loadImage(image, format='rgb8')
    imgOutput = jetson.utils.cudaAllocMapped(width=image.width, height=image.height, format='gray8')
    jetson.utils.cudaConvertColor(image, imgOutput)
